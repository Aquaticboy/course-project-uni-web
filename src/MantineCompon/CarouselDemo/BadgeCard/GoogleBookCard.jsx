import { IconStarFilled, IconCalendar, IconBook } from '@tabler/icons-react';
import { Badge, Card, Group, Image, Text, AspectRatio } from '@mantine/core';
import { Link } from 'react-router-dom';
import classes from './BadgeCard.module.css';

const GoogleBookCard = ({ item }) => {
    ...
    >
      ...
      <Card.Section className={classes.section} mt="md">
        ...
        <Group gap={5} mt={10} mb={10}>
          ...
          {rating && rating !== '0.0' && (
            <Badge size="xs" variant="filled" color="blue" leftSection={<IconStarFilled size={10} />}>
               {rating}
            </Badge>
          )}
        ...
        <Text fz="xs" c="dimmed" lineClamp={2} mb="md" style={{ minHeight: '38px' }}>
            {/* У Google книг поле опису ми на бекенді мапимо як description або overview */}
            {item.overview || item.description || "Опис відсутній..."}
        </Text>
      </Card.Section>
